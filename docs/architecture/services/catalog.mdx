...
- [tax/tax-rate/created](/architecture/services/tax#taxtax-rate-versioncreated): Used to import `TaxRate` from the `Tax` bounded context.
- [media/media/created](/architecture/services/media#mediamediacreated): Used to import `Media` from the `Media` bounded context.

## Important ADRs

- [Merge Category and Product Service](/architecture/adr/merge-category-and-product-service)
