...
- [user/user/created](/architecture/services/user#userusercreated): Used to validate that wishlists belong to an existing user
- [catalog/product-variant/created](/architecture/services/catalog#catalogproduct-variantcreated): Used to validate that product variants contained in wishlists exist
