...
- [tax/tax-rate/created](/docs/docs/architecture/services/tax#taxtax-rate-versioncreated): Used to import `TaxRate` from the `Tax` bounded context.
- [media/media/created](/docs/docs/architecture/services/media#mediamediacreated): Used to import `Media` from the `Media` bounded context.

## Important ADRs

- [Merge Category and Product Service](/docs/docs/architecture/adr/merge-category-and-product-service)
- [No category hierarchy](/docs/docs/architecture/adr/no-category-hierarchy)
