...
- [user/user/created](/docs/docs/architecture/services/user#userusercreated): Used to create default payment Methods for each user when created.
- [discount/order/validation-succeeded](/docs/docs/architecture/services/discount#discountordervalidation-succeeded): Used to start the payment process after the previous steps finished successfully.
