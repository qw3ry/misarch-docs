...
- [inventory/product-item/reservation-succeeded](/docs/docs/architecture/services/inventory#inventoryproduct-itemreservation-succeeded): Causes a validation of the order to check if the discounts can still be applied.
- [user/user/created](/docs/docs/architecture/services/user#userusercreated): Used to import `User` from the `User` bounded context.
- [catalog/category/created](/docs/docs/architecture/services/catalog#catalogcategorycreated): Used to import `Category` from the `Category` bounded context.
- [catalog/product/created](/docs/docs/architecture/services/catalog#catalogproductcreated): Used to import `Product` from the `Catalog` bounded context.
