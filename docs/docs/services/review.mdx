...
- [user/user/created](/docs/docs/services/user#userusercreated): Used to validate that reviews belong to an existing user
- [catalog/product-variant/created](/docs/docs/services/catalog#catalogproduct-variantcreated): Used to validate that product variants contained in reviews exist
